...
SENSORS = [
    ...
    ("glucose_age", "Glucose Age", UnitOfTime.SECONDS, None, EntityCategory.DIAGNOSTIC),
    # AAPS / insulin
    ("iob", "Insulin on Board", "U", None, None),
    ("cob", "Carbs on Board", UnitOfVolume.GRAMS, None, None),
    ...
    ("profile_target_low", "Profile Target Low (mmol/L)", "mmol/L", None, EntityCategory.CONFIG),
    ("profile_target_high", "Profile Target High (mmol/L)", "mmol/L", None, EntityCategory.CONFIG),
    ...
    ("carbs_required", "Carbs Required", UnitOfVolume.GRAMS, None, EntityCategory.DIAGNOSTIC),
    ...
    ("bg_cv", "BG Coefficient of Variation", PERCENTAGE, None, EntityCategory.DIAGNOSTIC),
    ...
    # Pump
    ("reservoir", "Pump Reservoir", UnitOfVolume.MILLILITERS, None, None),
    ...
    # Configuration
    ("low_mark", "AAPS Low Mark", "mmol/L", None, EntityCategory.CONFIG),
    ("high_mark", "AAPS High Mark", "mmol/L", None, EntityCategory.CONFIG),
    ("max_bolus", "AAPS Max Bolus", "U", None, EntityCategory.CONFIG),
    ("max_carbs", "AAPS Max Carbs", UnitOfVolume.GRAMS, None, EntityCategory.CONFIG),
    ...
    ("absorption_cutoff", "Carb Absorption Cutoff", UnitOfTime.HOURS, None, EntityCategory.CONFIG),
    ("min_carb_impact", "Minimum Carb Impact", "mg/dL", None, EntityCategory.CONFIG),
    ("dyn_isf_adjust", "Dynamic ISF Adjustment", None, None, EntityCategory.CONFIG),
    ("reservoir_warning", "Reservoir Warning", UnitOfVolume.MILLILITERS, None, EntityCategory.CONFIG),
    ("reservoir_critical", "Reservoir Critical", UnitOfVolume.MILLILITERS, None, EntityCategory.CONFIG),
...
def _value(data: dict[str, Any], key: str) -> Any:
    ...
    if key == "target_bg_mmol":
        ...
        return v / 18 if v is not None else None
    if key == "profile_target_low" or key == "profile_target_high":
        return data.get(key)
