...
SENSORS = [
    ...
    ("aaps_low_mark", "AAPS Low Mark", MMOL, None, EntityCategory.CONFIGURATION),
    ("aaps_high_mark", "AAPS High Mark", MMOL, None, EntityCategory.CONFIGURATION),
    ("aaps_max_bolus", "AAPS Max Bolus", U, None, EntityCategory.CONFIGURATION),
    ("aaps_max_carbs", "AAPS Max Carbs", G, None, EntityCategory.CONFIGURATION),
    ("autosens_min", "Autosens Minimum", None, None, EntityCategory.CONFIGURATION),
    ("autosens_max", "Autosens Maximum", None, None, EntityCategory.CONFIGURATION),
    ("carb_absorption_cutoff", "Carb Absorption Cutoff", UnitOfTime.HOURS, None, EntityCategory.CONFIGURATION),
    ("minimum_carb_impact", "Minimum Carb Impact", MGDL, None, EntityCategory.CONFIGURATION),
    ("dynamic_isf_adjustment", "Dynamic ISF Adjustment", None, None, EntityCategory.CONFIGURATION),
    ("reservoir_warning", "Reservoir Warning", U, None, EntityCategory.CONFIGURATION),
    ("reservoir_critical", "Reservoir Critical", U, None, EntityCategory.CONFIGURATION),
    ("pump_battery_warning", "Pump Battery Warning", PERCENTAGE, None, EntityCategory.CONFIGURATION),
    ("pump_battery_critical", "Pump Battery Critical", PERCENTAGE, None, EntityCategory.CONFIGURATION),
]
