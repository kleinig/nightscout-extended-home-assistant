...
SENSORS = [
    ...
    ("max_carbs", "AAPS Max Carbs", "g", None, EntityCategory.CONFIG),
    ...
    ("absorption_cutoff", "Carb Absorption Cutoff", "h", None, EntityCategory.CONFIG),
    ...
    ("pump_battery_warning", "Pump Battery Warning", "%", None, EntityCategory.CONFIG),
    ("pump_battery_critical", "Pump Battery Critical", "%", None, EntityCategory.CONFIG),
