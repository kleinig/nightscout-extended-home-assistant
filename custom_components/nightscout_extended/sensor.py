...
SENSORS = [
    ...
    ("autosens_ratio", "AAPS Autosens", "%", None, EntityCategory.DIAGNOSTIC),
    ("autosens_in_algorithm", "AAPS Autosens in Algorithm", "%", None, EntityCategory.DIAGNOSTIC),
    ...
    ("isf_for_carbs", "ISF for Calculator and Carbs Absorption", None, None, EntityCategory.DIAGNOSTIC),
